...
const COPY: Record<Locale, Record<string, string>> = {
  it: {
    "top.shipping": "Spedizione europea • assistenza dall’Italia",
    ...
    "home.kicker": "European home technology", "home.titleA": "Tecnologia per la casa,", "home.titleB": "scelta con criterio.", "home.lead": "Una selezione europea di elettrodomestici utili, supportata da persone vere e da oltre vent’anni di esperienza.", "home.explore": "Esplora lo shop", "home.story": "Conosci Ekobit", "home.delivery": "Consegne in Europa", "home.deliveryText": "Spedizioni tracciate nei Paesi disponibili", "home.secure": "Pagamenti protetti", "home.secureText": "Provider certificati e dati cifrati", "home.support": "Supporto umano", "home.supportText": "Prima, durante e dopo l’acquisto", "home.curated": "Selezione curata", "home.curatedText": "Meno rumore, più prodotti sensati", "home.categoriesKicker": "Trova il prodotto giusto", "home.categories": "Esplora per ambiente", "home.all": "Tutto il catalogo", "home.featuredKicker": "Scelte del momento", "home.featured": "Prodotti in evidenza", "home.catalog": "Apri il catalogo", "home.demo": "Catalogo dimostrativo", "home.demoText": "Questi prodotti di esempio mostrano l’esperienza dello shop mentre prepariamo l’assortimento reale.", "home.manifesto": "Non il catalogo più grande. Quello più chiaro.", "home.manifestoText": "Ekobit unisce competenza italiana, servizio europeo e un’esperienza digitale progettata per scegliere senza stress.", "home.years": "anni di esperienza", "home.countries": "lingue disponibili", "home.human": "assistenza reale",
    "catalog.kicker": "Catalogo europeo", "catalog.all": "Tutti i prodotti", "catalog.lead": "Una selezione essenziale, prezzi in euro e supporto prima e dopo l’acquisto.", "catalog.sort": "Ordina", "catalog.featured": "In evidenza", "catalog.priceAsc": "Prezzo crescente", "catalog.priceDesc": "Prezzo decrescente", "catalog.name": "Nome", "catalog.updating": "Aggiornamento catalogo…", "catalog.demo": "Stai esplorando il catalogo dimostrativo.", "catalog.found": "prodotti trovati", "catalog.empty": "Nessun prodotto trovato", "catalog.emptyText": "Prova una categoria diversa o una ricerca più semplice.", "catalog.reset": "Azzera i filtri",
    "product.details": "Dettagli", "product.add": "Aggiungi al carrello", "product.unavailable": "Non disponibile", "product.available": "Disponibile", "product.fast": "Consegna tracciata", "product.fastText": "Nei Paesi europei disponibili", "product.protected": "Acquisto protetto", "product.protectedText": "Garanzia legale applicabile", "product.sheet": "Scheda prodotto", "product.specs": "Caratteristiche tecniche", "product.related": "Prodotti correlati", "product.loading": "Caricamento prodotto…", "product.notFound": "Prodotto non trovato", "product.back": "Torna al catalogo",
    ...
    "footer.tagline": "Tecnologia utile per case europee, scelta con cura e supportata dall’Italia.", "footer.shop": "Acquista", "footer.company": "Ekobit", "footer.legal": "Informazioni legali", "footer.rights": "Tutti i diritti riservati.", "footer.settings": "Preferenze cookie",
  ...
  en: {
    "top.shipping": "European delivery • support from Italy",
    ...
    "footer.tagline": "Useful technology for European homes, carefully selected and supported from Italy.", "footer.shop": "Shop", "footer.company": "Ekobit", "footer.legal": "Legal information", "footer.rights": "All rights reserved.", "footer.settings": "Cookie preferences",
  ...
  fr: {
    ...
    "home.kicker": "Technologie domestique européenne", "home.titleA": "La technologie maison,", "home.titleB": "choisie avec exigence.", "home.lead": "Une sélection européenne d’appareils utiles, avec une assistance humaine et plus de vingt ans d’expérience.", "home.explore": "Explorer la boutique", "home.story": "Découvrir Ekobit", "home.delivery": "Livraison en Europe", "home.deliveryText": "Envois suivis vers les pays disponibles", "home.secure": "Paiements protégés", "home.secureText": "Prestataires certifiés et données chiffrées", "home.support": "Assistance humaine", "home.supportText": "Avant, pendant et après l’achat", "home.curated": "Sélection soignée", "home.curatedText": "Moins de bruit, plus de produits pertinents", "home.categoriesKicker": "Trouvez le bon produit", "home.categories": "Explorer par univers", "home.all": "Tout le catalogue", "home.featuredKicker": "Nos choix", "home.featured": "Produits en vedette", "home.catalog": "Ouvrir le catalogue", "home.demo": "Catalogue de démonstration", "home.demoText": "Ces exemples présentent l’expérience de la boutique pendant la préparation de l’assortiment réel.", "home.manifesto": "Pas le plus grand catalogue. Le plus clair.", "home.manifestoText": "Ekobit associe expertise italienne, service européen et expérience numérique sans stress.", "home.years": "ans d’expérience", "home.countries": "langues disponibles", "home.human": "assistance réelle",
    "catalog.kicker": "Catalogue européen", "catalog.all": "Tous les produits", "catalog.lead": "Une sélection essentielle, des prix en euros et une assistance complète.", "catalog.sort": "Trier", "catalog.featured": "En vedette", "catalog.priceAsc": "Prix croissant", "catalog.priceDesc": "Prix décroissant", "catalog.name": "Nom", "catalog.updating": "Mise à jour du catalogue…", "catalog.demo": "Vous explorez le catalogue de démonstration.", "catalog.found": "produits trouvés", "catalog.empty": "Aucun produit trouvé", "catalog.emptyText": "Essayez une autre catégorie ou une recherche plus simple.", "catalog.reset": "Réinitialiser",
    "product.details": "Détails", "product.add": "Ajouter au panier", "product.unavailable": "Indisponible", "product.available": "Disponible", "product.fast": "Livraison suivie", "product.fastText": "Dans les pays européens disponibles", "product.protected": "Achat protégé", "product.protectedText": "Garantie légale applicable", "product.sheet": "Fiche produit", "product.specs": "Caractéristiques techniques", "product.related": "Produits associés", "product.loading": "Chargement du produit…", "product.notFound": "Produit introuvable", "product.back": "Retour au catalogue",
    "page.about": "À propos", "page.support": "Assistance", "page.contact": "Contact", "page.privacy": "Politique de confidentialité", "page.cookies": "Politique cookies", "page.terms": "Conditions générales", "page.shipping": "Livraison et retours", "footer.tagline": "Technologie utile pour les foyers européens, sélectionnée et accompagnée depuis l’Italie.", "footer.shop": "Acheter", "footer.company": "Ekobit", "footer.legal": "Informations légales", "footer.rights": "Tous droits réservés.", "footer.settings": "Préférences cookies",
  ...
  de: {
    ...
    "home.kicker": "Europäische Haustechnik", "home.titleA": "Technik für Zuhause,", "home.titleB": "bewusst ausgewählt.", "home.lead": "Eine europäische Auswahl sinnvoller Haushaltsgeräte – mit echten Menschen und über zwanzig Jahren Erfahrung.", "home.explore": "Shop entdecken", "home.story": "Ekobit kennenlernen", "home.delivery": "Lieferung in Europa", "home.deliveryText": "Sendungsverfolgung in verfügbare Länder", "home.secure": "Geschützte Zahlungen", "home.secureText": "Zertifizierte Anbieter und verschlüsselte Daten", "home.support": "Persönlicher Support", "home.supportText": "Vor, während und nach dem Kauf", "home.curated": "Kuratierte Auswahl", "home.curatedText": "Weniger Lärm, mehr sinnvolle Produkte", "home.categoriesKicker": "Das richtige Produkt finden", "home.categories": "Nach Wohnbereich entdecken", "home.all": "Gesamter Katalog", "home.featuredKicker": "Aktuelle Auswahl", "home.featured": "Empfohlene Produkte", "home.catalog": "Katalog öffnen", "home.demo": "Demo-Katalog", "home.demoText": "Diese Beispielprodukte zeigen das Einkaufserlebnis, während wir das echte Sortiment vorbereiten.", "home.manifesto": "Nicht der größte Katalog. Der klarste.", "home.manifestoText": "Ekobit verbindet italienische Kompetenz, europäischen Service und stressfreies digitales Einkaufen.", "home.years": "Jahre Erfahrung", "home.countries": "verfügbare Sprachen", "home.human": "echter Support",
    "catalog.kicker": "Europäischer Katalog", "catalog.all": "Alle Produkte", "catalog.lead": "Eine klare Auswahl, Euro-Preise und Support vor und nach dem Kauf.", "catalog.sort": "Sortieren", "catalog.featured": "Empfohlen", "catalog.priceAsc": "Preis aufsteigend", "catalog.priceDesc": "Preis absteigend", "catalog.name": "Name", "catalog.updating": "Katalog wird aktualisiert…", "catalog.demo": "Sie sehen den Demo-Katalog.", "catalog.found": "Produkte gefunden", "catalog.empty": "Keine Produkte gefunden", "catalog.emptyText": "Versuchen Sie eine andere Kategorie oder eine einfachere Suche.", "catalog.reset": "Filter zurücksetzen",
    "product.details": "Details", "product.add": "In den Warenkorb", "product.unavailable": "Nicht verfügbar", "product.available": "Verfügbar", "product.fast": "Verfolgte Lieferung", "product.fastText": "In verfügbare europäische Länder", "product.protected": "Geschützter Kauf", "product.protectedText": "Anwendbare gesetzliche Gewährleistung", "product.sheet": "Produktdaten", "product.specs": "Technische Daten", "product.related": "Ähnliche Produkte", "product.loading": "Produkt wird geladen…", "product.notFound": "Produkt nicht gefunden", "product.back": "Zurück zum Katalog",
    "page.about": "Über uns", "page.support": "Hilfe", "page.contact": "Kontakt", "page.privacy": "Datenschutz", "page.cookies": "Cookie-Richtlinie", "page.terms": "Allgemeine Geschäftsbedingungen", "page.shipping": "Versand und Rückgabe", "footer.tagline": "Nützliche Technik für europäische Haushalte – sorgfältig ausgewählt und aus Italien betreut.", "footer.shop": "Shop", "footer.company": "Ekobit", "footer.legal": "Rechtliches", "footer.rights": "Alle Rechte vorbehalten.", "footer.settings": "Cookie-Einstellungen",
