...
const LEGAL_COPY: Record<Locale, Record<LegalDocument, LegalCopy>> = {
  it: {
    ...
    terms: { intro: "Queste condizioni costituiscono una bozza precontrattuale per il futuro shop europeo e dovranno essere completate con pagamenti, Paesi serviti e condizioni logistiche definitive.", sections: [
    ...
    shipping: { intro: "La logistica europea sarà attivata progressivamente. Paesi, tempi e costi definitivi verranno sempre mostrati prima del pagamento.", sections: [
  ...
  en: {
    ...
    terms: { intro: "These terms are a pre-contractual draft for the future European shop and must be completed with final payment, country and logistics details.", sections: [
    ...
    shipping: { intro: "European logistics will be enabled progressively. Final countries, times and costs will always be shown before payment.", sections: [
  ...
  fr: {
    ...
    terms: { intro: "Ces conditions sont un projet précontractuel pour la future boutique européenne, à compléter avant le lancement.", sections: [
    ...
    shipping: { intro: "La logistique européenne sera activée progressivement. Pays, délais et coûts seront affichés avant paiement.", sections: [
  ...
  de: {
    ...
    terms: { intro: "Diese Bedingungen sind ein vorvertraglicher Entwurf für den künftigen Europa-Shop und vor dem Start zu vervollständigen.", sections: [
    ...
    shipping: { intro: "Der Europaversand wird schrittweise aktiviert. Länder, Zeiten und Kosten erscheinen vor der Zahlung.", sections: [
  ...
  es: {
    ...
    terms: { intro: "Estas condiciones son un borrador precontractual para la futura tienda europea y deberán completarse antes del lanzamiento.", sections: [
    ...
    shipping: { intro: "La logística europea se activará progresivamente. Países, plazos y costes se mostrarán antes del pago.", sections: [
