...
const TITLES: Record<Locale, Record<string, string>> = {
  it: { home: "Ekobit | Tecnologia per la casa, scelta bene", catalog: "Catalogo | Ekobit", product: "Prodotto | Ekobit", cart: "Carrello | Ekobit", about: "Chi siamo | Ekobit", support: "Assistenza | Ekobit", contact: "Contatti | Ekobit", privacy: "Privacy policy | Ekobit", cookies: "Cookie policy | Ekobit", terms: "Termini e condizioni | Ekobit", shipping: "Spedizioni e resi | Ekobit" },
  en: { home: "Ekobit | Home technology, chosen well", catalog: "Catalog | Ekobit", product: "Product | Ekobit", cart: "Cart | Ekobit", about: "About us | Ekobit", support: "Support | Ekobit", contact: "Contact | Ekobit", privacy: "Privacy policy | Ekobit", cookies: "Cookie policy | Ekobit", terms: "Terms and conditions | Ekobit", shipping: "Shipping and returns | Ekobit" },
  ...
  de: { home: "Ekobit | Technik für Zuhause, gut gewählt", catalog: "Katalog | Ekobit", product: "Produkt | Ekobit", cart: "Warenkorb | Ekobit", about: "Über uns | Ekobit", support: "Hilfe | Ekobit", contact: "Kontakt | Ekobit", privacy: "Datenschutz | Ekobit", cookies: "Cookies | Ekobit", terms: "AGB | Ekobit", shipping: "Versand und Rückgabe | Ekobit" },
  es: { home: "Ekobit | Tecnología para el hogar, bien elegida", catalog: "Catálogo | Ekobit", product: "Producto | Ekobit", cart: "Carrito | Ekobit", about: "Quiénes somos | Ekobit", support: "Ayuda | Ekobit", contact: "Contacto | Ekobit", privacy: "Privacidad | Ekobit", cookies: "Cookies | Ekobit", terms: "Términos y condiciones | Ekobit", shipping: "Envíos y devoluciones | Ekobit" },
};
